...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static final int TAB_VIEW_PADDING_DIPS = 24; // Right, Left
    ...
    protected TextView createDefaultTabView(Context context, int position) {
        ...
        switch(position){
        	case 0:
	        	...
	        	break;
        	case 1:
            	textView.setCompoundDrawablesWithIntrinsicBounds(R.drawable.tab2_player, 0, 0, 0);
            	break;
        	case 2:
